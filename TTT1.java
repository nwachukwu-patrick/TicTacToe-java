...
class TTT1 extends JFrame implements ItemListener,ActionListener{
	...
	TTT1(){
	super("tictactoe game2 by youngtech");
	CheckboxGroup cbg=new CheckboxGroup();
	c1=new Checkbox("vscomputer",cbg,false);
	c2=new Checkbox("vsfriend",cbg,false);
	...
	for(i=0;i<=7;i++)
	for(j=0;j<=4;j++)
	a[i][j]=a1[i][j];//againinitialsingarray
	}
	else{//complogic
	for(i=0;i<=8;i++){
	if(e.getSource()==b[i]){
	...
	JOptionPane.showMessageDialog(TTT1.this,"!!!YOUwon!!!clickreset");
	break;
	}
	else if(icon1 == ic2) {
	...
	JOptionPane.showMessageDialog(TTT1.this,"won!clickreset");
	break;
	}
	}
	}
